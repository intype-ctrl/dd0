...
class AppService {
  ...
  Future openCommentReportEmail(context, Comment comment, UserModel? user, String supportEmail) async {
  ...
  Future launchAppReview(context, WidgetRef ref) async {
    ...
    await StoreRedirect.redirect(androidAppId: androidPackageName, iOSAppId: AppConfig.iosAppID);
    if (Platform.isIOS) {
